...
public class ConfigModerador extends JPanel {

    private final MainFrame mainFrame;

    public ConfigModerador(MainFrame mainFrame) {
        ...
        // ===== PANEL DE MODERACIÓN =====
        contentPanel.add(createLabel("Panel de Moderación", startX, 460, true));

        // ===== LOGOUT (Cerrar Sesión) =====
        JLabel logoutLabel = createLabelCentered(bundle.getString("config.logout"), startX, 510, new Color(180, 40, 70));
