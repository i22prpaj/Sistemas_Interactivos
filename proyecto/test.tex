...
\begin{itemize}
    \item \texttt{src/main}: lógica principal y navegación (MainFrame)
    \item \texttt{src/gui}: pantallas Swing (Login, Registro, Valoración, etc.)
    \item \texttt{src/model}: componentes reutilizables y modelos (ProfessorDirectory, perfiles, persistencia)
    \item \texttt{src/bundle}: ficheros de internacionalización (\texttt{Bundle\_es\_ES.properties}, \texttt{Bundle\_en.properties})
    \item \texttt{src/resources}: imágenes e iconos usados por la interfaz
